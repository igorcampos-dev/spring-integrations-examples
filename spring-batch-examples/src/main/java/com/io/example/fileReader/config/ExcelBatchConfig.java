...
public class ExcelBatchConfig {
    ...
    public PoiItemReader<StudentDto> excelReader() {
        ...
        reader.setResource(new InputStreamResource(new ClassPathResource("students.xlsx")));
