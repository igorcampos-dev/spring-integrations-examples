package com.io.example.dbReader.async.config;

import com.io.example.dbReader.async.model.dto.TestDto;
import com.io.example.dbReader.async.model.entity.TestEntity;
import com.io.example.dbReader.async.listener.LoggingStepListener;
import com.io.example.dbReader.async.mapper.TestEntityToDtoMapper;
...
import static com.io.example.dbReader.async.repository.query.TestEntityQuery.*;
...
public class AsyncBatchConfig {
    ...
    public Step asyncStep(JobRepository jobRepository,
        ...
        return new StepBuilder("asyncStep", jobRepository)
                .<TestEntity, Future<TestDto>>chunk(500, transactionManager)
                .reader(asyncReader)
