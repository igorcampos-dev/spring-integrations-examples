package com.io.example.dbReader.async.job;
...
import static com.io.example.dbReader.async.util.DataUtils.*;
...
@SpringBatchTest
@ActiveProfiles("test")
@DisplayName("AsyncBatchJob - Integration test with real Job execution")
class AsyncBatchJobIntegrationTest {
